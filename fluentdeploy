...
# "FOLLOW ME : BUDAVLEBAC1" çıktısını ekleyip 3 saniye bekleme
echo -e "${BOLD}${YELLOW}FOLLOW ME : BUDAVLEBAC1${RESET}"
sleep 3
...
# Karşılama metni
echo -e "${BOLD}${YELLOW}LM I AM HALO${RESET}"

print_command() {
  echo -e "${BOLD}${YELLOW}$1 LM${RESET}"
}
